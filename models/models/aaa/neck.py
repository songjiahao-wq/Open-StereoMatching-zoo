...
# @File    : neck.py
# @Comment :
from models.models.aaa.headplus import StereoNetHeadPlus
from models.models.aaa.FPN import FPN
from models.models.aaa.post_process import StereoNetPostProcessPlus
import torch
...
if __name__ == "__main__":
    ...
    inputs_l = [
        torch.randn(pipeline.B, c, pipeline.height // s, pipeline.width // s)
        for c, s in zip(pipeline.model_input_channels, pipeline.model_input_strides)
    ]
    inputs_r = [
        torch.randn(pipeline.B, c, pipeline.height // s, pipeline.width // s)
        for c, s in zip(pipeline.model_input_channels, pipeline.model_input_strides)
