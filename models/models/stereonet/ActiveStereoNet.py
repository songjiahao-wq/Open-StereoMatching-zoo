# -*- coding: utf-8 -*-
# @Time    : 2025/5/18 21:20
# @Author  : sjh
# @Site    : 
# @File    : ActiveStereoNet.py
# @Comment :
import torch
...
if __name__ == '__main__':
    ...
    input = torch.FloatTensor(1, 1, 480, 640).zero_().cuda()
    with torch.no_grad():
    ...
    torch.onnx.export(
        model,
        (input, input),
        "ActiveStereoNet.onnx",
        opset_version=16,
        input_names=["left", "right"],
        # output_names=["net0", "net1", "inp0", "inp1", "fmap1", "fmap2", "coords0", "coords1"],
